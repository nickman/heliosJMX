 ...
 */
/**
 * <p>Title: InstrumentedSocketConnection</p>
 * <p>Description: Instrumented replacement for {@link com.sun.jmx.remote.socket.SocketConnection}</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>com.sun.jmx.remote.socket.InstrumentedSocketConnection</code></p>
 */
public class InstrumentedSocketConnection implements SocketConnectionIf, MessageConnection {
	 ...
	 */
	public InstrumentedSocketConnection(Socket socket) throws IOException {
		if (logger.traceOn()) {
	 ...
	 */
	public InstrumentedSocketConnection(String addr, int port) throws IOException {
		if (logger.traceOn()) {
	...
	public void connect(Map env) throws IOException {
		...
		synchronized(stateLock) {
			if (state == UNCONNECTED) {
				...
				SocketHelper.log("Socket Created: Initial", sock);
				...
				sock = new Socket(addr, port);
				SocketHelper.log("Socket Created: Reconnecting", sock);
				replaceStreams(sock.getInputStream(), sock.getOutputStream());
	...
	public void setSocket(Socket s) throws IOException {
		sock = s;
		SocketHelper.log("Socket Replaced", s);
		replaceStreams(sock.getInputStream(), sock.getOutputStream());
	}
	...
	public Message readMessage() throws IOException, ClassNotFoundException {
		...
		SocketHelper.log("Socket Pre Reading Message", sock);
