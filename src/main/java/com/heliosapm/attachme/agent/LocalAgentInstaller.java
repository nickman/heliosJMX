...
public class LocalAgentInstaller  {
	...
	/** Static class logger */
	private static final SLogger LOG = SimpleLogger.logger(LocalAgentInstaller.class);
	...
	public static void main(String[] args) {
		...
		LOG.log("Instrumentation Deployed: %s", ManagementFactory.getPlatformMBeanServer().isRegistered(AgentInstrumentation.AGENT_INSTR_ON));
	}
