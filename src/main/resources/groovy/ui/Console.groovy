...
class Console implements CaretListener, HyperlinkListener, ComponentListener, FocusListener {
    ...
    public static URL ICON_PATH = Console.class.classLoader.getResource('/img/Helios_Symbol_30_45.png') // used by ObjectBrowser and AST Viewer
...
options:
  ...
  -cp,-classpath,--classpath <path>    Specify classpath'''
    ...
    public void installInterceptor() {
        ...
        //SystemStreamRedirector.set(systemOutInterceptor, systemErrorInterceptor);
    }
